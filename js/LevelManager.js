...
class LevelManager {
    ...
    _createLevels() {
        return [
            { id: 1, name: 'CLEAR_LOGS', desc: 'Delete attacker log files', difficulty: 1, barSpeed: 0.7, targetSize: 0.22, requiredHits: 8, maxTime: 25, unlocked: true, completed: false, bestScore: 0, lockpickDiff: 1 },
            ...
            { id: 3, name: 'REMOVE_MALWARE', desc: 'Remove malicious software', difficulty: 3, barSpeed: 1.1, targetSize: 0.15, requiredHits: 12, maxTime: 30, unlocked: false, completed: false, bestScore: 0, lockpickDiff: 3 },
            { id: 4, name: 'RESET_CREDS', desc: 'Reset leaked credentials', difficulty: 4, barSpeed: 1.2, targetSize: 0.12, requiredHits: 14, maxTime: 35, unlocked: false, completed: false, bestScore: 0, lockpickDiff: 4 },
            ...
            { id: 6, name: 'CUT_ACCESS', desc: 'Sever the attacker\'s link', difficulty: 6, barSpeed: 1.5, targetSize: 0.08, requiredHits: 18, maxTime: 60, unlocked: false, completed: false, bestScore: 0, lockpickDiff: 6 }
        ];
    }
